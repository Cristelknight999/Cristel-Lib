...
public enum ModVersionComparator {
    ...
    GREATER_EQUAL(">=") {
        public boolean test(String modId, String version) {
            return Services.MOD_LOADING.compare(modId, version)
    ...
    SAME_TO_NEXT_MINOR("~") {
        public boolean test(String modId, String version) {
            return Services.MOD_LOADING.compareMinor(modId, version);
        }
    },
    SAME_TO_NEXT_MAJOR("^") {
        public boolean test(String modId, String version) {
            return Services.MOD_LOADING.compareMajor(modId, version);
        }
    }*/;
