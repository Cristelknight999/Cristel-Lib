...
public abstract class StructureConfig {
    ...
    public abstract boolean addChanges(String modId, ResourceLocation setLocation);
    ...
    private void checkForError() {
        Set<ResourceLocation> setsToCheck = getConfigKeys();
    ...
    public ResourceLocation toDefaultId(String id) {
        if (id.contains(":")) return ResourceLocation.parse(id);
        else if (defaultNamespace.equals(Constants.MC_ID)) return ResourceLocation.withDefaultNamespace(id);
        else return ResourceLocation.fromNamespaceAndPath(defaultNamespace, id);
    }
