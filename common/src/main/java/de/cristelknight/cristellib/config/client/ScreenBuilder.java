...
import de.cristelknight.cristellib.config.simple.client.SimpleConfigScreen;
import de.cristelknight.cristellib.config.simple.client.SimpleScreenBuilder;
...
public class ScreenBuilder {
    ...
    private void addPlacementCategory(ConfigBuilder builder, StructureConfig structureConfig, ConfigEntryBuilder entryBuilder) {
        ...
        if(structureConfig.isAutoGenerated) placementCategory.addEntry(entryBuilder.startTextDescription(
    ...
    private void addEDCategory(ConfigBuilder builder, StructureConfig structureConfig, ConfigEntryBuilder entryBuilder) {
        ...
        if(structureConfig.isAutoGenerated) edCategory.addEntry(entryBuilder.startTextDescription(
                Component.translatable("cristellib.autoCategoryInfo")
        ).build());
